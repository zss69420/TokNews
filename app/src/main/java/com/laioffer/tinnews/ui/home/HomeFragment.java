...
public class HomeFragment extends Fragment implements CardStackListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //bind layout manager and adapter to card stack view
        binding.homeCardStackView.setLayoutManager(layoutManager);
        binding.homeCardStackView.setAdapter(swipeAdapter);

        // Handle like unlike button clicks, click like swipe to right, click unlike to left
    ...
    //below six methods are to override the card stack listener event
    @Override
    ...
    public void onCardSwiped(Direction direction) {
        if (direction == Direction.Left) {
            ...
            //if like, wire-up UI swipe interaction with data persistence
            //index start from 1, so we minus -1 to get actual index
